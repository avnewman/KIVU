var store = [,{
    ...
    "excerpt":"Date: August 2022 Activities: In early August, after retrieving our field equipment from Rwandan customs, we provided a one-after training exercise with seven students from the East African Institute for Fundamental Research (EAIFR). Afterward, five of the students were able to travel into the field with our team to learn...","url": "http://localhost:4000/KIVU/connections/2022training"
  },{
    "title": "Initial Kivu Project Training",
    "excerpt":"Date: May 2023 Activities: In May, we offered a day-long training exercise at the East African Institute for Fundamental Research (EAIFR). In this year 2 training, we detailed more about GNSS and InSAR methods, as well as gave an overview of magnetotellurics (MT) to the students studying within the program....","url": "http://localhost:4000/KIVU/connections/2023training"
  },{
    "title": "Training in Geodetic Techniques for Volcano and Tectonics Monitoring",
    "excerpt":"Date: 8-9 August 2024, 9a-4pm Location: University of Rwanda (Nyarugenge Campus), Einstein Block, ICTP-EAIFR Conference Room (5th floor) Organizers: Derrick Murekezi and Andrew Newman, Georgia Institute of Technology Host: Catherine Mériaux, East African Institute for Fundamental Research Participants: Attendee List Tech Recommendations: For hands-on modeling, of geodetic data, it is...","url": "http://localhost:4000/KIVU/connections/2024training"
  },{
